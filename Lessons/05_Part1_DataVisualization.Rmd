...
* geom_density_ridges
* geom_point
* geom_errorbar - make a trendline 
* geom_smooth
* geom_line 
* geom_area
...
#this line can be done inside the R code line but doing it up here will apply it to any gg plot in this chunk
...
print(O3plot)
#store the plot in an object, then print the object 
